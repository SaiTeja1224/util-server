...
import { type RefreshToken, type TPublicUser } from "../lib/types";
...
export const createUserHandler = catchAsync(async (req, res) => {
  ...
  return sendSuccess(res, 200, "User created successfully", response);
});

export const loginUserHandler = catchAsync(async (req, res) => {
